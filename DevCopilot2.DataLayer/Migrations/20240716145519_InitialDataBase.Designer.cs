...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20240716145519_InitialDataBase")]
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 7, 16, 18, 25, 17, 877, DateTimeKind.Local).AddTicks(4990),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2024, 7, 16, 18, 25, 17, 877, DateTimeKind.Local).AddTicks(5002),
                            Name = "شهاب",
