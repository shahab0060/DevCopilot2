...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20250221133351_AddGeneralSettings")]
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2025, 2, 21, 17, 3, 49, 192, DateTimeKind.Local).AddTicks(6816),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2025, 2, 21, 17, 3, 49, 192, DateTimeKind.Local).AddTicks(6835),
                            Name = "شهاب",
