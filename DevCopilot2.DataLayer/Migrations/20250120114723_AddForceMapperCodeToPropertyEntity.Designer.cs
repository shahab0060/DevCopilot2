...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20250120114723_AddForceMapperCodeToPropertyEntity")]
    partial class AddForceMapperCodeToPropertyEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2025, 1, 20, 15, 17, 20, 505, DateTimeKind.Local).AddTicks(9414),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2025, 1, 20, 15, 17, 20, 505, DateTimeKind.Local).AddTicks(9435),
                            Name = "شهاب",
