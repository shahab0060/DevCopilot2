...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20240724140320_ColorPickerInputHtml")]
    partial class ColorPickerInputHtml
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 7, 24, 17, 33, 17, 432, DateTimeKind.Local).AddTicks(8755),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2024, 7, 24, 17, 33, 17, 432, DateTimeKind.Local).AddTicks(8771),
                            Name = "شهاب",
