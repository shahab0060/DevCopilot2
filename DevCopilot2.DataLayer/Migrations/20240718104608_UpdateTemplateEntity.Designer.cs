...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20240718104608_UpdateTemplateEntity")]
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 7, 18, 14, 16, 6, 640, DateTimeKind.Local).AddTicks(9682),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2024, 7, 18, 14, 16, 6, 640, DateTimeKind.Local).AddTicks(9702),
                            Name = "شهاب",
