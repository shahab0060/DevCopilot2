...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20240731144558_AddButtonsInformationToTemplateEntity")]
    partial class AddButtonsInformationToTemplateEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 7, 31, 18, 15, 56, 271, DateTimeKind.Local).AddTicks(3637),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2024, 7, 31, 18, 15, 56, 271, DateTimeKind.Local).AddTicks(3652),
                            Name = "شهاب",
