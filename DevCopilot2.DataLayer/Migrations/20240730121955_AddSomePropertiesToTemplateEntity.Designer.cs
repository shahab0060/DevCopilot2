...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20240730121955_AddSomePropertiesToTemplateEntity")]
    partial class AddSomePropertiesToTemplateEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 7, 30, 15, 49, 53, 853, DateTimeKind.Local).AddTicks(4541),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2024, 7, 30, 15, 49, 53, 853, DateTimeKind.Local).AddTicks(4575),
                            Name = "شهاب",
