...
namespace DevCopilot.DataLayer.Migrations
{
    ...
    [Migration("20250124212854_ChangePropertyAndRelationEntities")]
    partial class ChangePropertyAndRelationEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevCopilot.Domain.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2025, 1, 25, 0, 58, 51, 981, DateTimeKind.Local).AddTicks(8452),
                            EditCounts = 0,
                            IsDelete = false,
                            IsSuperAdmin = true,
                            LastName = "بختیاری",
                            LatestEditDate = new DateTime(2025, 1, 25, 0, 58, 51, 981, DateTimeKind.Local).AddTicks(8482),
                            Name = "شهاب",
