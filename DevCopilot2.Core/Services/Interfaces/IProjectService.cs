...
namespace DevCopilot2.Core.Services.Interfaces
{
    public interface IProjectService : IService
    {
        ...
        Task<List<CreateProjectEnumDto>> GetCreateProjectEnumsFromLocation(ImportProjectEnumsFromLocationDto import);
        Task<List<BaseChangeEntityResult>> ImportProjectEnumsFromLocation(ImportProjectEnumsFromLocationDto import);
